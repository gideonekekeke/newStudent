...
function UbaniPage() {
	...
	const [logics, setLogics] = React.useState(0);
									...
									<div className='box_input'>
										<div className='box'>
											<div className='name_img1'>
												...
												<div style={{ marginLeft: "10px" }}>Admin(Logic)</div>
											</div>
											<center></center>
											<input
												onChange={(e) => {
													setLogics(e.target.value);
												}}
